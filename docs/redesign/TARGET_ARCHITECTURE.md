...
- My Plan is persisted against the revocable manager session, retains its immutable scenario decisions, freezes at the target deadline, and evaluates against finalized official outcomes.
